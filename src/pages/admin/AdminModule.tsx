...
const PERMISSIONABLE_MODULES: ModuleKey[] = ['dashboard','pipeline','contacts','companies','activities','tasks','calendar','forecast','reports','documents','automations','tickets','quotes_invoices','campaigns','knowledge_base','territories','billing','integrations'];
