...
export function Forecast() {
  ...
  const cards = [
    { l: 'Pipeline ouvert', v: formatMoney(totalOpen, cur), i: TrendingUp, c: 'blue' as const },
    { l: 'Forecast pondéré', v: formatMoney(weighted, cur), i: Target, c: 'orange' as const },
    { l: 'Gagné', v: formatMoney(totalWon, cur), i: Trophy, c: 'teal' as const },
  ] as const;
  ...
  return (
    <div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        {cards.map(c => {
          const r = COLOR_RAMPS[c.c]; const Icon = c.i;
          return (
