...
export const INTEGRATIONS: IntegrationDef[] = [
  ...
  { id: 'payunit', name: 'PayUnit', category: 'payments', authType: 'api_key', docsUrl: 'https://developer.payunit.net', logoColor: '0F172A', paymentSubcategories: ['card', 'mobile_money'], description: 'Cartes, Mobile Money et autres moyens de paiement internationaux.' },
